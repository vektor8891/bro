...
##' @description Safely loads an external package using requireNamespace and provides fallback behavior
...
safe_require_namespace <- function(package, fallback_function = NULL, error_message = NULL) {
  if (requireNamespace(package, quietly = TRUE)) {
    ...
    if (!is.null(error_message)) {
      ...
      warning("Package '", package, "' is not available. Install it to use this functionality.")
    }
