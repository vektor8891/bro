...
#'
#' @description
#' Loads and returns a specified dataset from the data registry in the given
#' execution environment.
#'
#' @details
#' This function retrieves the data registry from the provided execution
#' environment. It checks if the specified dataset exists in the registry and
#' if the path to the data is available. If the dataset or path is missing, an
#' error is raised. The function then loads the dataset using the specified
#' data loader based on the data type defined in the registry. Messages are
#' displayed indicating the successful loading of the dataset along with its
#' type and loading method.
#'
#' @param name The name of the dataset to be loaded, as specified in the data
#' registry.
#' @param execution The execution environment containing the data registry.
#'
#' @return Returns the loaded dataset, and it is also stored in the execution
